...
from Top_Down.Resources.Overlays import WHITE
from Top_Down.Resources.Rendering import *


class Template3d(ElementTemplate):
    dimension = 3
    _vertex_type = "v3f"
...
class RectPrism(Figure):
    ...
    def __init__(self, pos, l, w, h, texture=WHITE):
    ...
    def _create_vertex_list(self, verts, overlay):
...
class Cube(RectPrism):
    def __init__(self, pos, side_length, texture=WHITE):
